...
public class Principal {
    ...
    private final String API_KEY = "&apikey=674d4743";
    ...
    public void exibeMenu() {
        ...
        var menu = """
                ...
                6 - Top 5 séries
                7 - Buscara séries por categoria
                8 - Filtrar séris
                9 - Filtrar episódios por trecho
                10 - Top 5 episodios
    ...
    private void buscarSeriesPorAtor() {
        System.out.println("Qual ator ou atriz que deseja buscar");
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e ->
                    System.out.printf("Série: %s | Temporada: %s | Episódio: %s | Titulo: %s | Avaliacao: %s\n",
                            e.getSerie().getTitulo(), e.getTemporada(),
